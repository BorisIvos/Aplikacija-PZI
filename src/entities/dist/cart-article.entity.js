...
var CartArticle = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return article_entity_1.Article; }, function (article) { return article.cartArticles; }, { onDelete: "NO ACTION", onUpdate: "CASCADE" }),
        typeorm_1.JoinColumn([{ name: "article_id", referencedColumnName: "articleId" }])
    ], CartArticle.prototype, "article");
    __decorate([
        typeorm_1.ManyToOne(function () { return cart_entity_1.Cart; }, function (cart) { return cart.cartArticles; }, { onDelete: "NO ACTION", onUpdate: "CASCADE" }),
    ...
    CartArticle = __decorate([
        ...
        typeorm_1.Index("uq_cart_article_cart_id_article_id", ["cartId", "articleId"], { unique: true }),
