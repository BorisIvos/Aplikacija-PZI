...
var PhotoService = /** @class */ (function (_super) {
    ...
    function PhotoService(photo) {
        var _this = _super.call(this, photo) || this;
        _this.photo = photo;
        return _this;
    }
    PhotoService.prototype.delet = function (id) {
        throw new Error("Method not implemented.");
    };
    PhotoService.prototype.add = function (newPhoto) {
        return this.photo.save(newPhoto);
    };
    PhotoService.prototype.deleteById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.photo["delete"](id)];
