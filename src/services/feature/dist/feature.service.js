...
var FeatureService = /** @class */ (function (_super) {
    ...
    function FeatureService(feature //// Cim se spomene neki repozitori mora se evidentirati u osnovno modulu
    ) {
        var _this = _super.call(this, feature) || this;
        _this.feature = feature;
        return _this;
    }
    FeatureService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(feature_entity_1.Feature))
    ], FeatureService);
